...
class AnsibleManager:
    ...
    def check_ansible_installed(self) -> None:
        ...
        if not shutil.which("ansible-playbook"):
            raise RuntimeError(
                ...
                "Moondock uses 'push mode' where Ansible runs on your machine.\n"
    ...
    def execute_playbooks(
        ...
        playbooks_config : dict[str, Any]
            The 'playbooks' section from moondock.yaml
        instance_ip : str
    ...
    def _write_playbook_to_file(
        ...
        with tempfile.NamedTemporaryFile(
            mode="w",
            suffix=".yml",
            prefix=f"moondock-playbook-{name}-",
            delete=False,
        ) as f:
